...
// This solution MAY print nodes in same vertical order as they appear in tree
//  the above algorithm will print the values in preorder, so the nodes at same horizontal distances
